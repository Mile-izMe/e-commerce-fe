    ...
    <section aria-labelledby="hero-title" className="bg-[#eeece6]">
      <div className="mx-auto grid max-w-[1440px] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="flex flex-col justify-center px-6 py-16 sm:px-12 sm:py-20 lg:px-16">
          <p className="mb-8 text-[10px] font-medium tracking-[0.3em] text-neutral-500">
            ATELIER / EVERYDAY EDIT
          </p>
          <h1
            id="hero-title"
            className="max-w-lg text-[clamp(2.75rem,5vw,5rem)] font-normal leading-[1.08] tracking-[-0.055em] text-neutral-900"
          >
            Ít hơn.
            <br />
            <span className="font-serif italic text-[#79765f]">
              Đủ cho mỗi ngày.
            </span>
          </h1>
          ...
          <a
            href="#catalog"
            className="group inline-flex w-fit items-center gap-8 rounded-full bg-neutral-900 px-6 py-3.5 text-sm text-white transition hover:bg-neutral-700 focus-visible:outline-2 focus-visible:outline-offset-4"
          >
            Khám phá sản phẩm{" "}
            <ArrowUpRight
              aria-hidden
          ...
          <p className="mt-14 flex items-center gap-3 text-[10px] uppercase tracking-[0.2em] text-neutral-500">
        ...
        <div className="relative min-h-[340px] sm:min-h-[460px] lg:min-h-[610px]">
          ...
          />
          <span className="absolute bottom-6 right-6 rounded-full bg-white/70 px-4 py-2 text-[10px] tracking-[0.18em] text-neutral-700 backdrop-blur-sm">
